...
> - 예: `PRD-0001-user-auth`, `DESIGN-0001-auth-domain`, `TASK-0001-login-api`, `RUN-0001-user-auth`
...
CODE 단계의 세부 흐름(gate-keeper → code-reviewer → local-runner)은 `run` 스킬에서 정의한다.
